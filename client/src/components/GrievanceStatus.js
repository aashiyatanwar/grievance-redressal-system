...
//   <h2 className="text-2xl font-bold mb-4 text-center">Grievance Redressal Status</h2>
...
//       <label htmlFor="startDate" className="text-gray-700 mr-2 font-semibold">Start Date:</label>
//       <input
//         type="date"
//         id="startDate"
//         value={startDate}
...
//     </div>
//     <div className="flex items-center">
//       <label htmlFor="endDate" className="text-gray-700 mr-2 font-semibold">End Date:</label>
//       <input
//         type="date"
//         id="endDate"
//         value={endDate}
...
//     </div>
//     <div className="flex items-center">
//       <label htmlFor="statusFilter" className="text-gray-700 mr-2 font-semibold">Status:</label>
//       <select
//         id="statusFilter"
//         value={statusFilter}
...
//         <option value="Resolved" className="text-green-600 font-semibold">Resolved</option>
//         <option value="Pending" className="text-red-600 font-semibold">Pending</option>
//       </select>
//     </div>
//   </div>
...
//           <th className="px-4 py-2  bg-blue-500">Email ID</th>
//           <th className="px-4 py-2  bg-blue-500">Grievances</th>
//           <th className="px-4 py-2  bg-blue-500">Date of Submission</th>
//           <th className="px-4 py-2  bg-blue-500">Grievance Redressal Remarks</th>
//           <th className="px-4 py-2  bg-blue-500">Date of Redress</th>
//           <th className="px-4 py-2  bg-blue-500">Department</th>
//           <th className="px-4 py-2  bg-blue-500">Status</th>
//         </tr>
//       </thead>
//       <tbody>
...
//             <td className="px-4 py-2">{status.detail}</td>
//             <td className="px-4 py-2">
//               {new Date(status.dateOfSubmission).toLocaleDateString()}
//             </td>
//             <td className="px-4 py-2">{status.remarks}</td>
//             <td className="px-4 py-2">
//               {new Date(status.dateOfRedressal).toLocaleDateString()}
//             </td>
//             <td className="px-4 py-2">{status.department}</td>
//             <td
//               className={`px-4 py-2 ${
